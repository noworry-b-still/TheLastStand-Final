...
Shader "Mochie/Uber Shader" {
    Properties {
		...
		_PulseMask("", 2D) = "white" {}
		_SubsurfaceMask("", 2D) = "white" {}
		_TranslucencyMap("", 2D) = "black" {}
		_SubsurfaceTex("", 2D) = "white" {}
		...
		[Toggle(_)]_NonlinearSHToggle("", Int) = 1
		[Toggle(_)]_ApplyOutlineEmiss("", Int) = 0
		...
		[Toggle(_)]_ApplyOutlineLighting("", Int) = 0
		...
		[Enum(2D,0, CUBEMAP,1, 2D_CUBEMAP_BLEND,2)]_CubeMode("", Int) = 0
		[Enum(OFF,0, TOON,1, STANDARD,2)]_RenderMode("", Int) = 0
		...
		[Enum(Add,0, Mult,1, Alpha,2)]_MatcapBlending("", Int) = 2
		...
		[Enum(Separate,0, Packed3,1, Packed4,2)]_MaskingMode("", Int) = 0
		...
		_ShadowDitherStr("", Range(0,1)) = 0.25
		_SAtten("", Range(0,1)) = 0.8
		_SPen("", Range(0,1)) = 0.5
		_SSharp("", Range(0,1)) = 0.5
		_SStr("", Range(0,1)) = 1
		...
		_DirectContSTD("", Range(0,1)) = 1
		_IndirectContSTD("", Range(0,1)) = 1
		_RTDirectCont("", Range(0,1)) = 1
		_RTIndirectCont("", Range(0,1)) = 1
		_DisneyDiffuse("", Range(0,1)) = 0.5
		_SHStr("", Range(0,1)) = 0.1
		_MatcapStr("", Float) = 1
		...
		_RampWidth0("", Range(0.005,1)) = 0.005
		_RampWidth1("", Range(0.005,1)) = 1
		_RampWeight("", Range(0,1)) = 0
		_ReflectionStr("", Float) = 1
		_SpecStr("", Float) = 1
		_RimStr("", Range(0,1)) = 1
		...
		_DissolveBlendSpeed("", Range(0,1)) = 0.2
		...
		_UseReflCube("", Int) = 0
		_IsCubeBlendMask("", Int) = 0
		_NaNxddddd("", Float) = 0.0
		_ZWrite("", Float) = 1.0

		[Toggle(_)]_SSR("", Int) = 0
		_SSRMask("SSR mask", 2D) = "white" {}
		_NoiseTexSSR("Noise Texture", 2D) = "black" {}
		[Toggle(_)] _Dith("Low Res", int) = 0
		_Alpha("Reflection Strength", Range(0.0, 1.0)) = 1
		[IntRange]_MaxSteps ("Max Steps", Range(1,50)) = 50
